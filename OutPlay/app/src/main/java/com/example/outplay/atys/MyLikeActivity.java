...
public class MyLikeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_my_like);

        recyclerView=(RecyclerView)findViewById(R.id.show_recyclerview_4);
        List<String> list_id=getIntent().getExtras().getStringArrayList("list");
        ...
        query.findObjects(new FindListener<Article>() {
            ...
            public void done(final List<Article> list, BmobException e) {
                if (e == null) {
                    ...
                    GetUrlToPath getUrlToPath = new GetUrlToPath(list, MyLikeActivity.this);

                    getUrlToPath.setListPath();
                    list_path = getUrlToPath.getListPath();
                    adapter = new RecyAdapter(MyLikeActivity.this, list,list_path, new RecyAdapter.OnItemClickListener() {
                        @Override
                        public void OnClick(View v) {
                            int position = recyclerView.getChildAdapterPosition(v);
                            Intent intent = new Intent(MyLikeActivity.this, ContentShowActivity.class);
